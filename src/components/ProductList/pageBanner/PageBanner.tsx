      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
        <div className="flex flex-col md:flex-row md:items-end md:justify-between text-white gap-4">
          ...
          <div className="flex items-center space-x-2 text-sm pb-2">
            <Link
              to="/"
              className="hover:text-[#08ABFF]  text-[16px] cursor-pointer transition text-gray-200"
            >
              Home
            </Link>
            <span className="text-[#08ABFF] font-bold text-[16px]">
              {" "}
              {">"}{" "}
            </span>
            <span className="text-[#08ABFF] font-semibold text-[16px]">
              Shop
            </span>
          </div>
        </div>
