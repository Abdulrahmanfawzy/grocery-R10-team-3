        ...
        {features.map((feature, index) => (
          <div key={index} className="flex items-center gap-6">
            ...
            <div className="flex flex-col">
              <h4 className="font-bold text-slate-900 text-[16px] leading-snug">
                {feature.title}
              </h4>
              <p className="text-[13px] text-slate-400 max-w-[220px] leading-normal font-medium mt-0.5">
                {feature.description}
              </p>
            </div>
          </div>
