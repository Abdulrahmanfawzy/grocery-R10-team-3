...
import {
  ...
  useCreateSmartList,
  type CreateSmartListFormValues,
} from "@/lib/api/profile/smartListApi/use-createList";

function CreateList() {
  const { mutate, isPending } = useCreateSmartList();
  ...
  const {
    ...
    watch,
    formState: { errors },
  } = useForm<CreateSmartListFormValues>({
    resolver: zodResolver(createSmartListSchema),
    defaultValues: { name: "", description: "", meal_ids: [] },
  });
  ...
  const onSubmit = (data: CreateSmartListFormValues) => {
    console.log(data);
      ...
      <DialogContent className="sm:max-w-sm">
        <form onSubmit={handleSubmit(onSubmit)}>
          <DialogHeader>
            ...
            <DialogDescription>
              Create your List here. Click save when you&apos;re done.
            </DialogDescription>
          </DialogHeader>
